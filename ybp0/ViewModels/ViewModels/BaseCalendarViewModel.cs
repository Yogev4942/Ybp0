...
namespace ViewModels.ViewModels
{
    ...
    /// </summary>
    public abstract class BaseCalendarViewModel : BaseViewModel
    {
        ...
        protected BaseCalendarViewModel(IDatabaseService dbService, INavigationService navigationService, User user)
        {
